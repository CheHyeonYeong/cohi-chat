...
public enum ErrorCode {
	...
	GRACE_WINDOW_HIT(HttpStatus.UNAUTHORIZED, "이미 재발급된 토큰입니다. (유예 기간)"),
	...
	SEMANTIC_SEARCH_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE,
		"의미 기반 검색을 현재 사용할 수 없습니다. 잠시 후 다시 시도해주세요."),
