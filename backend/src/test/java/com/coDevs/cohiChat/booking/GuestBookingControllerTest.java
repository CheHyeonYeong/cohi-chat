...
import com.coDevs.cohiChat.booking.controller.GuestBookingController;
...
class GuestBookingControllerTest {
    ...
    @Test
    @DisplayName("성공: 게스트 예약이 없으면 빈 목록 반환 - 200 OK")
    void getBookingsByGuestIdEmptyList() throws Exception {
        // given
        given(bookingService.getBookingsByGuestId(GUEST_ID))
            .willReturn(List.of());
