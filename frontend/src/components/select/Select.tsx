...
const triggerStyles = cn(
    'flex items-center justify-between w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-cohi-text-dark',
...
const itemStyles = cn(
    'relative flex items-center px-3 py-2 rounded-md text-sm text-cohi-text-dark cursor-pointer select-none',
    'data-[highlighted]:bg-cohi-bg-warm data-[highlighted]:outline-none',
